...
def convert_vertical_slash_indexes(
    ...
    torch.ops.sgl_kernel_sycl.convert_vertical_slash_indexes.default(
        block_count,
        block_offset,
        column_count,
        column_index,
...
def convert_vertical_slash_indexes_mergehead(
    ...
    torch.ops.sgl_kernel_sycl.convert_vertical_slash_indexes_mergehead.default(
        block_count,
        block_offset,
        column_count,
        column_index,
...
def sparse_attn_func(
    ...
    *,
    ...
    out, softmax_lse = torch.ops.sgl_kernel_sycl.fwd_sparse.default(
        q,
        k,
        v,
        block_count,
...
def sparse_attn_varlen_func(
    ...
    *,
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse = torch.ops.sgl_kernel_sycl.varlen_fwd_sparse.default(
        q,
        k,
        v,
        block_count,
