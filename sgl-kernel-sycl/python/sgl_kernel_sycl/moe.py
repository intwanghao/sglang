...
def fp8_blockwise_scaled_grouped_mm(
    ...
    torch.ops.sgl_kernel_sycl.fp8_blockwise_scaled_grouped_mm.default(
        output,
        a_ptrs,
        b_ptrs,
        out_ptrs,
...
def prepare_moe_input(
    ...
    torch.ops.sgl_kernel_sycl.prepare_moe_input.default(
        topk_ids,
        expert_offsets,
        blockscale_offsets,
        problem_sizes1,
...
def apply_shuffle_mul_sum(
    ...
    torch.ops.sgl_kernel_sycl.apply_shuffle_mul_sum.default(
...
def cutlass_fp4_group_mm(
    ...
    torch.ops.sgl_kernel_sycl.cutlass_fp4_group_mm.default(
        c,
        a_fp4,
        b_fp4,
        a_blockscale,
