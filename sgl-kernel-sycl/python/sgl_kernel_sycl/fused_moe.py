...
def fused_marlin_moe(
    ...
    intermediate_cache1 = torch.ops.sgl_kernel_sycl.moe_wna16_marlin_gemm.default(
        hidden_states,
        intermediate_cache1,
        w1,
        w1_scale,
    ...
    intermediate_cache3 = torch.ops.sgl_kernel_sycl.moe_wna16_marlin_gemm.default(
        intermediate_cache2,
        intermediate_cache3,
        w2,
        w2_scale,
