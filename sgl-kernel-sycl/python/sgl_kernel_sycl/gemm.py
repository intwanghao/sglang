...
import torch
from sgl_kernel_sycl.utils import _get_cache_buf, get_cuda_stream


def awq_dequantize(
    qweight: torch.Tensor, scales: torch.Tensor, qzeros: torch.Tensor
) -> torch.ByteTensor:
    return torch.ops.sgl_kernel_sycl.awq_dequantize.default(qweight, scales, qzeros)


def int8_scaled_mm(mat_a, mat_b, scales_a, scales_b, out_dtype, bias=None):
    return torch.ops.sgl_kernel_sycl.int8_scaled_mm.default(
        mat_a,
        mat_b,
        scales_a,
        scales_b,
...
def fp8_blockwise_scaled_mm(mat_a, mat_b, scales_a, scales_b, out_dtype):
    return torch.ops.sgl_kernel_sycl.fp8_blockwise_scaled_mm.default(
        mat_a,
        mat_b,
        scales_a,
        scales_b,
...
def fp8_scaled_mm(mat_a, mat_b, scales_a, scales_b, out_dtype, bias=None):
    return torch.ops.sgl_kernel_sycl.fp8_scaled_mm.default(
        mat_a,
        mat_b,
        scales_a,
        scales_b,
...
def _bmm_fp8_internal(
    ...
    torch.ops.sgl_kernel_sycl.bmm_fp8.default(
        A,
        B,
        D,
        A_scale,
...
def dsv3_fused_a_gemm(
    ...
    torch.ops.sgl_kernel_sycl.dsv3_fused_a_gemm.default(output, mat_a, mat_b)
    return output
...
def sgl_per_token_group_quant_fp8(
    ...
    torch.ops.sgl_kernel_sycl.sgl_per_token_group_quant_fp8.default(
...
def sgl_per_token_group_quant_int8(
    ...
    torch.ops.sgl_kernel_sycl.sgl_per_token_group_quant_int8.default(
...
def sgl_per_tensor_quant_fp8(
    ...
    torch.ops.sgl_kernel_sycl.sgl_per_tensor_quant_fp8.default(
...
def sgl_per_token_quant_fp8(
    ...
    torch.ops.sgl_kernel_sycl.sgl_per_token_quant_fp8.default(input, output_q, output_s)
...
def cutlass_scaled_fp4_mm(
    ...
    torch.ops.sgl_kernel_sycl.cutlass_scaled_fp4_mm.default(
...
def scaled_fp4_quant(
    ...
    torch.ops.sgl_kernel_sycl.scaled_fp4_quant.default(
...
def qserve_w4a8_per_chn_gemm(
    ...
    torch.ops.sgl_kernel_sycl.qserve_w4a8_per_chn_gemm.default(
...
def qserve_w4a8_per_group_gemm(
    ...
    torch.ops.sgl_kernel_sycl.qserve_w4a8_per_group_gemm.default(
...
def dsv3_router_gemm(
    ...
    torch.ops.sgl_kernel_sycl.dsv3_router_gemm(
        output,
        hidden_states,
        router_weights,
    )
...
def shuffle_rows(input_tensor, dst2src_map, output_tensor_shape):
    ...
    torch.ops.sgl_kernel_sycl.shuffle_rows.default(input_tensor, dst2src_map, output_tensor)
...
def scaled_fp4_experts_quant(
    ...
    torch.ops.sgl_kernel_sycl.scaled_fp4_experts_quant.default(
        output,
        output_scales,
        input_tensor,
        input_global_scale,
